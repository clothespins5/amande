...
} from "../../container/find-paint/find-paints-and-view-results/find-paints-and-view-results.component";
import {
  SelectColorFromImageComponent
} from "../../container/find-paint/select-color-from-image/select-color-from-image.component";
