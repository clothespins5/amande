...
public class CIEDE2000 {
    ...
    /**
     * 参考:https://qiita.com/hachisukansw/items/860f061a2ab7a4f2d06f
     */
    public static double calculation(LAB source, LAB destination, int kL, int kC, int kH) {

        Function<Double, Double> radianToDegree = (radian) -> { return radian * (180d / Math.PI); };
        Function<Double, Double> degreeToRadian = (degree) -> { return degree * (Math.PI / 180d); };
